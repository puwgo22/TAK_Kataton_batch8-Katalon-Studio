...
WebUI.verifyElementVisible(findTestObject('TC-01-Login/msg_Login failed'), FailureHandling.OPTIONAL)

WebUI.callTestCase(findTestCase('Blocks/Login'), [('username') : username, ('password') : password], FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementVisible(findTestObject('TC-02-Make Appointment/h2_Make Appointment'))
