...
WebUI.setText(findTestObject('Object Repository/TC-01-Login/input_username'), GlobalVariable.empty_user)

WebUI.setEncryptedText(findTestObject('Object Repository/TC-01-Login/input_password'), GlobalVariable.password)
