...
WebUI.callTestCase(findTestCase('Blocks/Make Appointment Success'), [('facility') : facility, ('visit_date') : visit_date
        , ('comment') : comment, ('healthcare_program') : healthcare_program, ('hospital_readmission') : hospital_readmission], 
